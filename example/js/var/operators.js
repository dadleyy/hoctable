...
const OPERATORS = {
  ...
  HAS_NO_VALUE : {text: i18n("operators.has_no_value"), id: "has_value"},
  IS_ANY       : {text: i18n("operators.is_any"), id: "has_value"},
  CONTAINS     : {text: i18n("operators.contains"), id: "has_value"}
};
